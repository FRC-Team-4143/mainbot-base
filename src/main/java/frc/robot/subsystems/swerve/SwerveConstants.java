...
public class SwerveConstants extends MWConstants {
    ...
    public static final double ODOMETRY_FREQUENCY = new CANBus(MODULE_CANBUS_NAME).isNetworkFD() ? 250.0 : 100.0;
    ...
    public static final double ROBOT_MASS_KG = Units.lbsToKilograms(140.0); // Mass of the robot in pounds
    public static final double BUMPER_WIDTH_METERS = Units.inchesToMeters(34.75); // Width of the bumpers in meters (y
                                                                                  // axis : left -> right)
    public static final double BUMPER_LENGTH_METERS = Units.inchesToMeters(34.75); // Length of the bumpers in meters (x
                                                                                   // axis : front -> back)
    public static final double WHEEL_COF = 1.916; // Coefficient of friction for the wheels VEX Grip V2
    ...
    private static final Slot0Configs STEER_GAINS = new Slot0Configs().withKP(80).withKI(0).withKD(0).withKS(0)
            .withKV(0).withKA(0);
    // When using closed-loop control, the drive motor uses VelocityVoltage
    private static final Slot0Configs DRIVE_GAINS = new Slot0Configs().withKP(0.5).withKI(0).withKD(0).withKS(0.18)
    ...
    public static final Translation2d FL_MODULE_TRANSLATION = new Translation2d(Units.inchesToMeters(11.4),
            Units.inchesToMeters(11.4));
    public static final SwerveModuleConstants<TalonFXConfiguration, TalonFXConfiguration, CANcoderConfiguration> FL_MODULE_CONSTANTS = CONSTANT_CREATOR
    ...
    public static final Translation2d FR_MODULE_TRANSLATION = new Translation2d(Units.inchesToMeters(11.4),
            Units.inchesToMeters(-11.4));
    public static final SwerveModuleConstants<TalonFXConfiguration, TalonFXConfiguration, CANcoderConfiguration> FR_MODULE_CONSTANTS = CONSTANT_CREATOR
            .createModuleConstants(
                    4,
                    3,
                    1,
    ...
    public static final Translation2d BL_MODULE_TRANSLATION = new Translation2d(Units.inchesToMeters(-11.4),
            Units.inchesToMeters(11.4));
    public static final SwerveModuleConstants<TalonFXConfiguration, TalonFXConfiguration, CANcoderConfiguration> BL_MODULE_CONSTANTS = CONSTANT_CREATOR
            .createModuleConstants(
                    6,
                    5,
                    2,
    ...
    public static final Translation2d BR_MODULE_TRANSLATION = new Translation2d(Units.inchesToMeters(-11.4),
            Units.inchesToMeters(-11.4));
    public static final SwerveModuleConstants<TalonFXConfiguration, TalonFXConfiguration, CANcoderConfiguration> BR_MODULE_CONSTANTS = CONSTANT_CREATOR
            .createModuleConstants(
                    8,
                    7,
                    3,
