...
public enum SuperstructureTargets {
  ...
  SuperstructureTargets(Optional<Double> elevator_height, Rotation2d arm_angle) {
    elevator_height_ = elevator_height;
    arm_angle_ = arm_angle;
  }

  SuperstructureTargets(double elevator_height, Rotation2d arm_angle) {
